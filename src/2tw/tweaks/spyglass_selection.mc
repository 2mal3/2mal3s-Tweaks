...
function main {
  ...
  tag @s add 2tw.spyglassSelection.this0
  execute if data storage 2tw:data gamerules{spyglassSelection: 1b} as @e[team=!thisTeamDoesNotExist,distance=1..] run {
    tag @s add 2tw.spyglassSelection.this1
    execute as @p if predicate 2tw:tweaks/spyglass_selection/looking_at_filter as @e[tag=2tw.spyglassSelection.this1] run effect give @s minecraft:glowing 15 0 true
    tag @s remove 2tw.spyglassSelection.this1
  }
  tag @s remove 2tw.spyglassSelection.this0
}
