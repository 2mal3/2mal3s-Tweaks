...
function place {
  ...
  execute as @e[type=minecraft:armor_stand,sort=nearest,limit=1,tag=!2tw.armorStandArms.processed,tag=!global.ignore,tag=!smithed.entity,tag=!smithed.strict,tag=!smithed.block] run {
