...
# death_chest
execute if score $death_chest 2tw.config matches 0 run tellraw @s [{"text":"[\u274c]","color":"dark_red","clickEvent":{"action":"run_command","value":"/function 2mal3:2tw/menu/buttons/death_chest/true"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Death chest","color":"gold","hoverEvent":{"action":"show_text","contents":"Players who take damage have a certain probability to get infected and receive negative effects."}}]
execute if score $death_chest 2tw.config matches 1 run tellraw @s [{"text":"[\u2714]","color":"dark_green","clickEvent":{"action":"run_command","value":"/function 2mal3:2tw/menu/buttons/death_chest/false"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Death chest","color":"gold","hoverEvent":{"action":"show_text","contents":"Players who take damage have a certain probability to get infected and receive negative effects."}}]

# death_coordinates
execute if score $death_coordinates 2tw.config matches 0 run tellraw @s [{"text":"[\u274c]","color":"dark_red","clickEvent":{"action":"run_command","value":"/function 2mal3:2tw/menu/buttons/death_coordinates/true"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Death coordinates","color":"gold","hoverEvent":{"action":"show_text","contents":"Spawns a death chest at died players with their items."}}]
