# Description: Fills the second half of the placed chest with the items in the players inventory
# AS: every player that dies, AT: the second half of the placed chest
