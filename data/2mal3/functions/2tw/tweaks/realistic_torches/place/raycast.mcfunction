...
execute if block ~ ~ ~ minecraft:torch align xyz run summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["2tw.realistic_torch", "global.ignore"]}
