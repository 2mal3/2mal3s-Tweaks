...
execute if block ~ ~ ~ #2mal3:2tw/tweaks/path_generator/grass run setblock ~ ~ ~ minecraft:dirt

# Path blocks in the nether
execute if block ~ ~ ~ #2mal3:2tw/tweaks/path_generator/nylium run setblock ~ ~ ~ minecraft:netherrack
