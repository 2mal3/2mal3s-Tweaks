...
execute if score $disabled_ender_eyes 2tw.config matches 1 run tellraw @a[scores={2tw.debug_mode=4..}] [{"text":"[","color":"gray"},{"text":"2mal3sTweaks","color":"aqua"},{"text":"/","color":"gray"},{"text":"DEBUG","color":"aqua"},{"text":"]: ","color":"gray"},{"text":"Deleted ","color":"aqua"},{"selector":"@s","color":"gray"},{"text":"!","color":"aqua"}]
