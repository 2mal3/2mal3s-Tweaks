...
execute unless score .temp_0 2tw.data matches 2584.. run tellraw @s [{"text":"[","color":"gray"},{"text":"2mal3'sTweaks","color":"gold"},{"text":"/","color":"gray"},{"text":"WARN","color":"gold"},{"text":"]: ","color":"gray"},{"text":"This Minecraft version is not supported by the datapack. Please use a version later than 1.16.","color":"gold"}]

execute if score .temp_1 2tw.data matches 1 run tellraw @s [{"text":"[","color":"gray"},{"text":"2mal3'sTweaks","color":"gold"},{"text":"/","color":"gray"},{"text":"WARN","color":"gold"},{"text":"]: ","color":"gray"},{"text":"This Minecraft version is not supported by the datapack. Please use a version later than 1.16.","color":"gold"}]
